...
def build_parser(): 
    ...
    version_name_parser = subparser.add_parser("version_name",help="gets the current version name of E.L.Y.S.I.U.M")
    version_name_parser.set_defaults(func=version_name)

    stable_parser = subparser.add_parser("is_stable",help="checks if current E.L.Y.S.I.U.M is stable or not")
    ...
    version_checker_parser = subparser.add_parser("check_version",help="Checks if new version is available or not ")
